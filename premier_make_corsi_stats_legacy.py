...
exclusions, and Corsi event tallying. This legacy script is for the original three seasons
and calls SEASONS_LEGACY form the constants.py file.
...
from constants import SEASONS_LEGACY
...
def organize_by_season(df):
    ...
    Args:
    ----
        SEASONS_LEGACY global constant(list): List of season years (e.g., [20152016, 20162017]).
